...
import { LayoutDashboard, Rocket, Settings, LifeBuoy, BookOpen, Layers, Shield } from "lucide-react";
      ...
      <SidebarHeader className="p-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <span className="text-xl font-black tracking-tighter text-white uppercase italic">AgentForge</span>
